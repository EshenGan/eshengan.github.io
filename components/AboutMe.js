    ...
    <section className="bg-white dark:bg-gray-800">
      ...
      <div className="bg-[#F1F1F1] -mt-10 dark:bg-gray-900">
        <div className="text-container max-w-6xl mx-auto pt-20">
          ...
          >
            {userData.about.title}. <p className="mt-2"></p>Currently working on{" "}
            <a
              className="bg-pink-400 rounded-md px-2 py-1 text-white"
        ...
        <div className="pt-20 grid grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto gap-y-20 gap-x-20">
          ...
          <div className="inline-flex flex-col">
            <div>
              ...
              <p className="text-gray-800 dark:border-gray-300 font-bold dark:text-gray-300">
                {userData.email}
              </p>
              <p className="mt-3">
              <svg
            ...
            <div className="mt-8">
              ...
              <p className="text-lg text-gray-500 mt-4 dark:text-gray-300">
                I'm actively looking for a full-time job as fresh graduate starting summer 2022, please do check out my{" "}
                <a
            ...
            <div className="mt-4 ml-4">
              <div className="flex flex-row justify-start items-center ">
                ...
                >
                  ...
                  <p className="text-lg text-gray-800 font-mono relative overflow-hidden dark:text-gray-300">
